<template>
  <footer class="VPFooter">
    <div class="container">
	  <p class="contact-us">
		<span class="content">
			联系地址：深圳市南山区粤海街道科技园社区科发路2号30区3栋262&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;E-mail：service@xvector.ai&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;联系电话：18612533679
		</span>
	  </p>
      ...
      <p v-if="theme.footerConfig.publicSecurityRecordCode" class="recordCode">
        ...
        <span class="content">
			<a href="https://beian.mps.gov.cn/#/query/webSearch?code=44030002002023" rel="noreferrer" target="_blank">{{ theme.footerConfig.publicSecurityRecordCode }}</a>
        </span>
      </p>
