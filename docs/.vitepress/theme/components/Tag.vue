			...
			<a-row :gutter="24">
				...
				<a-col :span="24">
					<a-card :style="{ width: '100%', marginBottom: '20px' }">
						<a-tag v-for="(tag, tagTitle) in tags" @click="toggleTag(tagTitle.toString())"
							:class="selectTag === tagTitle.toString() ? 'tag-checkable-checked tag-item' : 'tag-item'">
					...
					<a-card :style="{ width: '100%' }" class="no-result" v-if="!selectTag">
						<svg role="img" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
							...
							<defs>
								...
								<linearGradient id="d" x1="-0.392" y1="1.114" x2="0.5" y2="0.396"
									gradientUnits="objectBoundingBox">
									<stop offset="0" stop-color="#fff" stop-opacity="0" />
							...
							<g transform="translate(-135 -375)">
								...
								<path d="M-2493,98s-56.355,45.651-64,16,74.25-17.75-16,72" transform="translate(3044 409)"
									fill="none" stroke="#909aa9" stroke-linecap="round" stroke-width="2"
									stroke-dasharray="10" />
								<path
